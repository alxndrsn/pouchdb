...
function maintainNativeIndexes(openReq, reject) {
  console.log('indexeddb.maintainNativeIndexes()');
  ...
  ddocsReq.onsuccess = function (e) {
    ...
    try {
      ...
      globalThis.maintainNativeIndexes = 'complete: ' + globalThis.__magic_number;
      console.log('maintainNativeIndexes() complete:', globalThis.__magic_number);
    } catch (err) {
      reject(err);
    }
  };
