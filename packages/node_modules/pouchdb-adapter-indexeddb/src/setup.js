...
import { LOCAL_DOC_STORE, MAIN_DOC_STORE, META_STORE, rawIndexFields, naturalIndexName, correctIndexFields } from './util';
...
function maintainNativeIndexes(openReq, reject) {
  var docStore = openReq.transaction.objectStore(MAIN_DOC_STORE);
...
function upgradePouchDbSchema(db, pouchdbVersion) {
  if (pouchdbVersion < 1) {
    ...
    var docStore = db.createObjectStore(MAIN_DOC_STORE, {keyPath : 'id'});
