...
function IdbPouch(dbOpts, callback) {
  ...
  api._get = $t(get, [LOCAL_DOC_STORE, MAIN_DOC_STORE]); // TODO can be more selective with which store we're opening here
  ...
  api._getRevisionTree = $t(getRevisionTree, [LOCAL_DOC_STORE, MAIN_DOC_STORE]); // TODO as per get(), we could check and only open correct store here
