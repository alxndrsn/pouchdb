'use strict';
import { adapterFun, changesHandler } from 'pouchdb-utils';
    ...
    const finishOpenRevs = () => {
      ...
      leaves.forEach((leaf) => {
        api.get(id, {
          ...
          count--;
          if (!count) {
            console.log('finishOpenRevs()', '         myResult:', JSON.stringify(myResult));
            console.log('finishOpenRevs()', 'returning: result:', JSON.stringify(result));
            cb(null, result);
          }
        });
      });
