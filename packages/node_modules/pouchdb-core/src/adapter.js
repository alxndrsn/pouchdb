...
class AbstractPouchDB extends EventEmitter {
  _setup() {
    ...
    this.get = adapterFun('get', function (id, opts, cb) {
      ...
      console.log('@@@ adapter.js', opts, cb.toString());
      ...
      return this._get(id, opts, (err, result) => {
        console.log('@@@ adapter.js', 'received from _get():', JSON.stringify(result));
        ...
        if (opts.attachments && doc._attachments) {
          ...
          console.log('@@@ adapter.js', 'calling callback with:', JSON.stringify(doc));
          cb(null, doc);
        }
      });
    }).bind(this);
