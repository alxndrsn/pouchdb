...
function checkBlobSupport(txn, store, docIdOrCreateDoc) {
  return new Promise(function (resolve) {
    ...
    txn.onabort = function (e) {
      console.log('checkBlobSupport()', 'txn.abort');
      // Historically, if the transaction aborts now its due to not being able to
      // write to the database, likely due to the disk being full.  It can also
      // abort on WebKitGTK 2.51.0 (Playwright 1.56.1) due to changed behaviour.
      e.preventDefault();
      e.stopPropagation();
      resolve(false);
    };
    ...
    req.onerror = function (e) {
      console.log('checkBlobSupport()', 'error');
      resolve(false);
    };
  }).catch(function () {
