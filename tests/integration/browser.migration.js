      ...
      describe('indexeddb', () => {
        ...
        if (versionGte(scenario, '7.2.1')) {
          it('Should support indexeddb->indexeddb upgrades', () => {
            // TODO: this is a demonstration test, showing that all docs in the
            // db receive a new property, `migrated:true`.  It also confirms
            // that attachments are OK.
            //
            // This test can be repurposed to check that documents are moved to
            // the correct location when changing the indexeddb doc store layout.
