...
Now we'll implement the syncing. You need to have a compatible server instance. You can either install [CouchDB](http://couchdb.apache.org/) or use a hosted Couch service such as [Cloudant](https://cloudant.com/)
