...
class Sync extends EE {
  constructor(src, target, opts, callback) {
    ...
    const promise = Promise.all([
      ...
      this.cancel('pouchdb-replication/sync'); // FIXME remove this - added to help debug numListeners in test.retry.js
      if (callback) {
