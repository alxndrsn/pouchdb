...
function init(api, opts, callback) {
  ...
  console.log('idb.init()', 'dbName:', dbName);
  ...
  api._info = function idb_info(callback) {
    console.log('adapter-idb._info()', 'ENTRY');
    var updateSeq;
    var docCount;
  ...
  console.log('calling indexedDB.open()', 'dbName:', dbName, 'ADAPTER_VERSION:', ADAPTER_VERSION, 'nonce:', Math.random());
  var req = indexedDB.open(dbName, ADAPTER_VERSION);
  console.log('indexedDB.open() returned OK.');
  ...
  req.onversionchange = function (e) {
    console.log('indexedDB.open()', 'onversionchange');
  };
  ...
  req.onsuccess = function (e) {
    ...
    // First, check blob support.  If this is attempted within a
    // shared transaction, then failure will break everything else.
    ...
    function completeSetup() {
      console.log('success.completeSetup()', 'ENTRY', 'storedMetaDoc:', storedMetaDoc);
      if (typeof blobSupport === 'undefined' || !storedMetaDoc) {
        console.log('success.completeSetup()', 'returning early.');
        return;
      }
      api._meta = {
        name: dbName,
      ...
      console.log('success.completeSetup()', 'calling back...');
      callback(null, api);
    }

    function storeMetaDocIfReady() {
      console.log('success.storeMetaDocIfReady()', { docCount, metaDoc });
      if (typeof docCount === 'undefined' || typeof metaDoc === 'undefined') {
        console.log('success.storeMetaDocIfReady()', 'returning early.');
        return;
      }
      var instanceKey = dbName + '_id';
      console.log('success.storeMetaDocIfReady()', 'instanceKey:', instanceKey);
      ...
      console.log('success.storeMetaDocIfReady()', 'Putting meta doc...');
    ...
    console.log('metastore:', metastore, META_STORE);
    const getMetastore = metastore.get(META_STORE);
    getMetastore.onerror = function (e) {
      console.log('getMetastore.error');
    };
    getMetastore.onsuccess = function (e) {
      console.log('getMetastore.success');
      console.log('get(META_STORE) returned:', e);
    ...
    txn.oncomplete = function () {
      console.log('txn.oncomplete');
      storedMetaDoc = true;
      completeSetup();
    };
    txn.onabort = function (e) {
      console.log('txn.onabort');
      idbError(callback)(e);
    };
  }, 1);
  }
