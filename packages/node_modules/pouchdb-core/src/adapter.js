...
class AbstractPouchDB extends EventEmitter {
  _setup() {
    const hasGetLocal = typeof this._getLocal === 'function';
    const hasPutLocal = typeof this._putLocal === 'function';
    const hasRemoveLocal = typeof this._removeLocal === 'function';

    this.post = this.put = adapterFun('put', function (doc, opts, cb) {
      ...
      if (hasPutLocal && isLocalId(doc._id)) {
        if (doc._deleted) {
      ...
      if (opts.force && doc._rev) {
        transformForceOptionToNewEditsOption(opts, doc);
        putDoc(opts, doc, function (err) {
    ...
    this.remove = adapterFun('remove', function (docOrId, optsOrRev, opts, callback) {
      ...
      if (hasRemoveLocal && isLocalId(newDoc._id)) {
...
function transformForceOptionToNewEditsOption(opts, doc) {
