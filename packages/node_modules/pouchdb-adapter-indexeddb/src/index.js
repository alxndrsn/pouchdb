    ...
    const finishOpenRevs = () => {
      ...
      for (let i=leaves.length-1; i>=0; --i) {
        ...
        if (!(rev in mySpecialDoc.revs)) {
          ...
          processing.push(new Promise((resolve, reject) => {
            ...
            processAttachments(api, mySpecialDoc, result, opts, NO_CTX_REQUIRED, cb);
          }));
      ...
      leaves.forEach((leaf) => {
        api.get(id, {
          ...
          attachments: opts.attachments, // handled
          binary: opts.binary, // handled
          ...
          if (!count) {
            ...
            if (myJson.length !== oldJson.length) {
              console.log('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@');
              console.log('@');
