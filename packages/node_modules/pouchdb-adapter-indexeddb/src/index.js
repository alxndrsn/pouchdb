...
function IdbPouch(dbOpts, callback) {
  ...
  api._get = $t(get, [DOC_STORE, META_STORE]); // FIXME don't need to open META_STORE
  api._getLocal = $t(getLocal, [DOC_STORE, META_STORE]); // FIXME don't need to open DOC_STORE
  ...
  // TODO add _put()
  // TODO add _putLocal()
  // TODO research _putLocalNoLock() & _putLocalWithLock()
